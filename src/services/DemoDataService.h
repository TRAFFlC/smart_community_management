...
private:
    ...
    static void initMenus(DatabaseManager &db)
    {
        ...
        while (q.next())
        {
            db.insert("sys_role_menu", {{"role_id", 19}, {"menu_id", q.value(0).toInt()}});
        }

        // 为其他角色分配合理菜单
        auto assignMenusToRole = [&](int roleId, QList<int> menuIds)
        {
            for (int mid : menuIds)
            {
        ...
        assignMenusToRole(1, {1, 101, 102, 103, 3, 301, 302, 304, 307, 308, 5, 501, 502, 503, 7, 706});
        // 物业客服
        assignMenusToRole(6, {1, 101, 102, 103, 2, 202, 203, 204, 205, 3, 301, 302, 303, 304, 307, 308, 6, 601, 604});
        // 物业经理
        assignMenusToRole(10, {1, 101, 102, 103, 2, 202, 203, 204, 205, 206, 3, 301, 302, 303, 304, 305, 306, 307, 308, 309, 6, 601, 604});
        // 网格员
        assignMenusToRole(13, {1, 101, 102, 103, 2, 204, 207, 208, 4, 401, 402, 403, 6, 602});
        // 社区工作人员
        assignMenusToRole(14, {1, 101, 102, 103, 2, 201, 202, 203, 204, 207, 208, 4, 401, 402, 403, 404, 405, 5, 501, 502, 6, 602, 604});
        // 社区书记
        assignMenusToRole(15, {1, 101, 102, 103, 2, 201, 202, 203, 204, 207, 208, 4, 401, 402, 403, 404, 405, 406, 6, 602, 604});
        // 街道工作人员
        assignMenusToRole(16, {1, 101, 102, 103, 4, 401, 404, 406, 6, 602, 604});
        // 业委会成员
        assignMenusToRole(18, {1, 101, 103, 3, 304, 306, 309, 6, 604});
    }
    ...
    static void initUsers(DatabaseManager &db)
    {
        auto addUser = [&](const QString &username, const QString &password,
                           ...
                           int userType, int roleId, qint64 orgId = 0)
        {
            ...
            db.insert("sys_user_role", {{"user_id", uid}, {"role_id", roleId}});
            if (orgId > 0)
            {
        ...
        // 平台管理员
        addUser("admin", "admin123", QStringLiteral("系统管理员"), "13800000001", 3, 19);

        // 居民
        qint64 r1 = addUser("zhangsan", "123456", QStringLiteral("张三"), "13800001001", 0, 1);
        addUser("lisi", "123456", QStringLiteral("李四"), "13800001002", 0, 1);
        addUser("wangwu", "123456", QStringLiteral("王五(租户)"), "13800001003", 0, 3);
        addUser("liulou", "123456", QStringLiteral("刘楼长"), "13800001004", 0, 4);

        // 物业
        addUser("wuye_kefu", "123456", QStringLiteral("小美(客服)"), "13800002001", 1, 6);
        addUser("wuye_guanjia", "123456", QStringLiteral("陈管家"), "13800002002", 1, 7);
        addUser("wuye_weixiu", "123456", QStringLiteral("老张(维修)"), "13800002003", 1, 8);
        addUser("wuye_baoan", "123456", QStringLiteral("小李(保安)"), "13800002004", 1, 9);
        addUser("wuye_jingli", "123456", QStringLiteral("陈明(经理)"), "13800002005", 1, 10);

        // 社区治理
        addUser("wangge_zhao", "123456", QStringLiteral("赵网格"), "13800003001", 1, 13);
        addUser("shequ_lifang", "123456", QStringLiteral("李芳"), "13800003002", 1, 14);
        addUser("shequ_shuji", "123456", QStringLiteral("周书记"), "13800003003", 1, 15);
        addUser("jiedao_worker", "123456", QStringLiteral("吴干事"), "13800003004", 1, 16);
        addUser("jiedao_leader", "123456", QStringLiteral("马主任"), "13800003005", 1, 17);
